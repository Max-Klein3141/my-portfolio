...
const SUGGESTED_PROMPTS = [
  "How do you think about the relationship between AI and financial infrastructure?",
  "What does discipline actually mean as a competitive advantage?",
  "How should a young founder think about long-term time horizons?",
  "What draws you to the intersection of AI and venture capital?",
  "How does athletic training shape the way you approach building?",
];
...
function Cursor() {
  return (
    <motion.span
      className="inline-block w-[2px] h-[1em] bg-white/50 ml-[2px] align-middle"
...
function EmptyState({ onSelect }: { onSelect: (text: string) => void }) {
  return (
    ...
    >
      ...
      >
        Ask about building,<br className="hidden sm:block" />
        systems, or the future.
      </motion.h2>
      ...
      >
        A conversational interface into the worldview of Max Klein —
        founder, athlete, and long-term thinker.
      </motion.p>
      ...
      <div className="relative z-10 flex-1 overflow-y-auto
        ...
        <div className="max-w-[720px] mx-auto">
          <AnimatePresence mode="wait">
            {!hasMessages ? (
              <EmptyState key="empty" onSelect={(t) => { setInput(t); send(t); }} />
            ) : (
              <motion.div
                key="messages"
                initial={{ opacity: 0 }}
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <textarea
                ...
                onKeyDown={handleKey}
                placeholder="Ask about building, systems, AI, finance, or long-term thinking…"
                disabled={streaming}
                rows={1}
            ...
            <p className="mt-2.5 text-[10px] font-[400] tracking-[0.05em]
              ...
              Powered by Claude · Shift+Enter for new line · Responses reflect Max Klein's worldview
            </p>
          </form>
        </div>
      </div>
